...
* The original package name 'com.sha.serverusermanagement.server-user-management' is invalid and this project uses 'com.sha.serverusermanagement.serverusermanagement' instead.
